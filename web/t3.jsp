...
<html lang="en">
<head>
    <link rel="icon" href="assets/img/airplane.png" type="image/x-icon">
    <base href="<%=basePath%>">
...
<aside class="app-sidebar">
    <div class="app-sidebar__user">
        <div>
            ...
            <span class="app-sidebar__user-name">经办人:</span>
            <span class="app-sidebar__user-designation"><s:property value="%{#session.loginUser.account}"/></span>
        </div>
    </div>
    <ul class="app-menu">
...
<main class="app-content">
    ...
    <div class="row">
        <div class="col-md-6">
            <div class="tile" style="height: 650px">
                <div class="tile-title-w-btn">
                    <h3 class="title">购票信息</h3>
                </div>
                <div class="tile-body" style="font-size: 20px;line-height:35px;">
                    ...
                    <s:form method="post" action="buyTicket">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" placeholder="请输入姓名" name="order.name" style="width: 300px">
                        </div>
                        <div class="form-group">
                            <label class="control-label">身份证</label>
                            <input class="form-control" type="text" placeholder="请输入身份证" name="order.idCard" style="width: 280px">
                        </div>
                        <div class="form-group">
                        ...
                        <input class="btn btn-info" id="demoNotify" type="submit" value="购票" style=" position: absolute; bottom: 10px;left: 300px "/>
                    </s:form>
                </div>
            </div>
        </div>
